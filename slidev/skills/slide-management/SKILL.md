...
description: Manage slide additions and deletions with automatic renumbering. Always use this skill when adding, deleting, or renumbering slides. Uses manage-slides.py script for git-aware operations.
version: 0.4.0
---
